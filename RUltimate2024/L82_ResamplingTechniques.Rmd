...
```{r}
c(train, val, test) %<-% train_val_test_split(df = df) # we use multi-assignment operator because the function returns 3 values
...
This is why we should use cross validation
