...
text_1984_separate_words <- str_split(text_1984_one_single_string, pattern = " ")[[1]]
```
...
text_1984_separate_words <- str_replace_all(string = text_1984_separate_words, pattern = "[0-9]", replacement = "")

# delete hyphens

text_1984_separate_words <- str_replace_all(string = text_1984_separate_words, pattern = "-", replacement = " ") 
...
```{r}
single_chars <- str_to_lower(string = strsplit(text_1984_one_single_string, split = "")[[1]])
