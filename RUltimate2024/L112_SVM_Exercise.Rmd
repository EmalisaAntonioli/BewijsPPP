...
```{r}
"I guess it could be considered regression because the target values could in a range 0-4."
```
...
```{r}
"No, the validation accuracy is even lower than the baseline classifier"
```
