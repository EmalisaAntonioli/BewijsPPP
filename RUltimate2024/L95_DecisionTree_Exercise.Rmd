...
Check the summary of the data to see if there are missing values. Are there any missing? No
...
val$target_pred_class <- ifelse(val$target_pred >threshold, 1, 0) %>% as.factor()# put your code here
```
