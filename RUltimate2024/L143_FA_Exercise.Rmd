...
```{r}
"decisive has a msa of 0.65 and with that is the lowest, this might be considered unimportant, 
though i think it is too high for that. All others are 0.83 or higher and thus suitable"
```
...
```{r}
"yes, the elbow method also suggests two components"
```
